...
var backendConfig = {
	...
	plugins: [
		...
		// 	onBuildStart: ['./node_modules/forever/bin/forever stop ./bundle/backend.js'],
			// onBuildEnd: ['./node_modules/forever/bin/forever start ./bundle/backend.js && ./node_modules/forever/bin/forever restart ./bundle/backend.js ']
		// })
	],
	module: {
		rules: [
			{
				exclude: ['./src/app/odm/*', './dist/src/**/*.spec.ts']
			},
			{
				test: /\.ts$/,
				loaders: [
