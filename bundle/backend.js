...
var StoreManager = /** @class */ (function () {
    ...
    StoreManager.prototype.modelsInit = function () {
        ...
        // this.LocalUser.belongsTo(this.User, {foreignKey: 'ownerId'});
    };
    ...
    StoreManager.prototype.updateCreateCard = function (cardData, deckId) {
        return __awaiter(this, void 0, void 0, function () {
            var findResponses;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    StoreManager.prototype.updateCreateDeck = function (deckData) {
        return __awaiter(this, void 0, void 0, function () {
            var findResponses;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.Deck.findAll({ where: { id: deckData.id } })];
                    case 1:
                        findResponses = _a.sent();
                        if (!(findResponses.length > 0)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.Deck.update(deckData, { where: { id: deckData.id } })];
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3: return [4 /*yield*/, this.Deck.create(deckData)];
                    case 4: return [2 /*return*/, _a.sent()];
                }
            });
        });
